...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_dom__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_dom___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react_dom__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_path_to_regexp__ = __webpack_require__(119);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__StoreCreator__ = __webpack_require__(207);
...
var ArticleService = function () {
    ...
    (0, _createClass3.default)(ArticleService, [{
         ...
         */
        value: function fetchArticles(next) {
            return next([{
                "key": "20180427-1",
                "title": "My article",
                ...
                "leader": ["Second article's leader text", "second line..."]
            }]);
        }
    }]);
...
exports.LIST_ARTICLES_FAILED = exports.RECEIVE_ARTICLES = exports.LIST_ARTICLES = undefined;

var _extends2 = __webpack_require__(66);

var _extends3 = _interopRequireDefault(_extends2);

exports.ListArticlesMiddleware = ListArticlesMiddleware;
exports.listArticlesFailed = listArticlesFailed;
exports.listArticles = listArticles;
exports.receiveArticles = receiveArticles;
exports.receiveArticlesReducer = receiveArticlesReducer;

var _ArticleService = __webpack_require__(36);

var _simpleReactRouter = __webpack_require__(19);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var LIST_ARTICLES = exports.LIST_ARTICLES = "LIST_ARTICLES";
var RECEIVE_ARTICLES = exports.RECEIVE_ARTICLES = 'RECEIVE_ARTICLES';
var LIST_ARTICLES_FAILED = exports.LIST_ARTICLES_FAILED = 'LIST_ARTICLES_FAILED';

/** 
 * Async mutating middleware that loads the full list of articles and then dispatches an action to render
 * them 
 */
function ListArticlesMiddleware() {
        ...
        return function (dispatch) {
            return function (action) {
                ...
                if (action.type === LIST_ARTICLES) {
                    var arcticleService = new _ArticleService.ArticleService();
                    articleService.fetchArticles(function (articles) {
                        return dispatch(receiveArticles(articles));
                    });
                    _simpleReactRouter.history.push('/clearblog/list');
                }
            };
        };
    };
...
function receiveArticlesReducer(state, action) {
...
var _ListArticles = __webpack_require__(65);

var _RootReducer = __webpack_require__(151);

var _ArticlesPage = __webpack_require__(152);
...
var routes = [{ path: '/clearblog/', action: function action(store) {
        return _react2.default.createElement(_ArticlesPage2.default, { store: store });
    } }, { path: '/clearblog/list', action: function action(store) {
        return _react2.default.createElement(_ArticlesPage2.default, { store: store });
    } }]; /**
 ...
 */
var router = new _simpleReactRouter.SimpleReactRouter(routes, _RootReducer.rootReducer, initialState, [(0, _ListArticles.ListArticlesMiddleware)()]);
...
articleService.fetchArticles(function (articles) {
    return router.dispatch((0, _ListArticles.receiveArticles)(articles));
});
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(62), __webpack_require__(135)(module)))
...
function rootReducer(state, action) {
    switch (action.type) {
        case _ListArticles.RECEIVE_ARTICLES:
            return (0, _ListArticles.receiveArticlesReducer)(state, action);
        default:
            return state;
    }
}
...
exports.ArticlesPage = undefined;
...
var _chanochComComponents = __webpack_require__(197);

var _Article = __webpack_require__(198);

var _config = __webpack_require__(205);

var _config2 = _interopRequireDefault(_config);

var _ListArticle = __webpack_require__(206);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ArticlesPage = exports.ArticlesPage = function (_React$Component) {
    (0, _inherits3.default)(ArticlesPage, _React$Component);

    function ArticlesPage(props) {
        (0, _classCallCheck3.default)(this, ArticlesPage);

        var _this = (0, _possibleConstructorReturn3.default)(this, (ArticlesPage.__proto__ || (0, _getPrototypeOf2.default)(ArticlesPage)).call(this, props));

        _this.selectArticle = _this.selectArticle.bind(_this);
        return _this;
    }
    ...
    (0, _createClass3.default)(ArticlesPage, [{
        key: 'selectArticle',
        value: function selectArticle(key) {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        articles && articles.map && articles.map(function (article) {
                            return _react2.default.createElement(_Article.ArticleSummary, { key: article.key, article: article });
                        })
                    )
                )
            );
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        listArticle: function listArticle() {
            return dispatch((0, _ListArticle.listArticle)());
        }
    };
};

var ConnectedArticlesPage = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(ArticlesPage);

exports.default = ConnectedArticlesPage;
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(67)(Function.call, __webpack_require__(80).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(82);
...
exports.ArticleSummary = exports.Article = undefined;

var _Article = __webpack_require__(199);

exports.Article = _Article.Article;
exports.ArticleSummary = _Article.ArticleSummary;
...
exports.Leader = exports.ArticleSummary = undefined;
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'div',
                                { className: 'section_article__item' },
                                _react2.default.createElement(
                                    'h4',
                                    { className: 'article_title', 'data-hover': article.title },
                                    article.title
                                ),
...
var ArticleSummary = exports.ArticleSummary = function (_Component2) {
    (0, _inherits3.default)(ArticleSummary, _Component2);

    function ArticleSummary(props) {
        (0, _classCallCheck3.default)(this, ArticleSummary);

        var _this2 = (0, _possibleConstructorReturn3.default)(this, (ArticleSummary.__proto__ || (0, _getPrototypeOf2.default)(ArticleSummary)).call(this, props));

        _this2.clicked = _this2.clicked.bind(_this2);
        return _this2;
    }

    (0, _createClass3.default)(ArticleSummary, [{
        key: 'clicked',
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        'h4',
                                        { 'data-hover': article.title, onClick: this.clicked },
                                        article.title
                                    )
                                ),
                                _react2.default.createElement(Leader, { leader: article.leader })
                            )
                        )
                    )
                )
...
var Leader = exports.Leader = function (_Component3) {
    ...
    (0, _createClass3.default)(Leader, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                null,
                leader && leader.map(function (line, index) {
                    return _react2.default.createElement(
                        'p',
                        { key: index },
                        line
...
// module
exports.push([module.i, "/* \n.section_article__item\n    .article_title \n        h4\n            .article_info\n                li\n                    a\n    .article_desc\n\n.section_article-item_body\n  \n\n.section_article-item_body__img\n.section_article-item_body__info\n    li\n        a\n\n    .social__list\n\n.section_article-item__comments\n    .comments__list\n        .comment\n            .comment__avatar\n            .comment__content\n                .comment__user\n                .comment__date\n                .comment__message\n                .comment__reply\n                    a\n\n*/\n\n.section__heading {\n    font-family: Rozha One,serif;\n    font-weight: 400;\n    font-size: 2.5rem;\n    line-height: 1.42857;\n    color: #efefef;\n}\n\n.section_article__item\n{\n    margin-bottom: 3rem;\n}\n.section_article__item .article_title\n{\n    text-decoration: none;\n}\n.section_article__item .article_title > h4\n{\n    color: #a9a9a9;\n    margin-bottom: .5rem;\n    font-size: 1.375rem;\n    font-family: Rozha One,serif;\n    line-height: 1.42857;\n    font-weight: 400;\n    margin-top:0;\n}\n.section_article__item .article_title > h4:before\n{\n    position: absolute;\n\n    content: attr(data-hover);\n    transition: opacity .5s, -webkit-transform .5s;\n    transition: transform .5s, opacity .5s;\n    transition: transform .5s, opacity .5s, -webkit-transform .5s; \n\n    color: #fff;\n}\n.section_article__item .article_title > h4:hover:before,\n.section_article__item .article_title > h4:focus:before\n{\n    -webkit-transform: scale(.9);\n            transform: scale(.9);\n\n    opacity: 0;\n}\n.section_article__item .article_info\n{\n    font-size: .875rem; \n    font-style: italic;\n\n    margin: 0;\n    padding: 0;\n\n    list-style: none;\n}\n.section_article__item .article_info > li\n{\n    display: inline-block; \n    padding-right: .5rem;\n    font-weight: 400;\n}\n.section_article__item .article_info > li > a\n{\n    text-decoration: none;\n    color: #efefef;\n}\n.section_article__item .article_desc\n{\n    line-height: 1.5;\n}\n.section_article-item_body\n{\n    margin-bottom: 1.5rem;\n}\n.section_article-item_body__img\n{\n    margin-bottom: 1.5rem;\n}\n.section_article-item_body__info\n{\n    font-size: .875rem;\n    font-style: italic;\n\n    margin-bottom: 1.5rem;\n    padding: 0;\n\n    list-style: none;\n\n    text-align: center;\n}\n.section_article-item_body__info > li\n{\n    display: inline-block; \n\n    padding: .5rem;\n}\n.section_article-item_body__info > li > a\n{\n    text-decoration: none;\n}\n.section_article-item .social__list\n{\n    text-align: left;\n}\n.section_article-item__comments\n{\n    margin-top: 3rem;\n}\n.section_article-item__comments .comments__list\n{\n    padding: 0; \n\n    list-style: none;\n}\n.section_article-item__comments .comments__list .comment\n{\n    display: -webkit-box;\n    display: flex; \n\n    margin-bottom: 3rem;\n    padding-bottom: 1rem;\n}\n.section_article-item__comments .comments__list .comment .comment__avatar\n{\n    width: 15%;\n    margin-right: 1rem;\n}\n.section_article-item__comments .comments__list .comment .comment__content\n{\n    width: 85%;\n}\n.section_article-item__comments .comments__list .comment .comment__content .comment__user\n{\n    margin-bottom: 0;\n}\n.section_article-item__comments .comments__list .comment .comment__content .comment__date\n{\n    font-size: .875rem;\n    font-style: italic;\n}\n.section_article-item__comments .comments__list .comment .comment__content .comment__message\n{\n    margin: .5rem 0;\n}\n.section_article-item__comments .comments__list .comment .comment__content .comment__reply\n{\n    text-align: right;\n}\n.section_article-item__comments .comments__list .comment .comment__content .comment__reply > a\n{\n    text-decoration: none;\n}\n", ""]);
...
exports.LIST_ARTICLE_FAILED = exports.RECEIVE_ARTICLE = exports.LIST_ARTICLE = undefined;

var _extends2 = __webpack_require__(66);

var _extends3 = _interopRequireDefault(_extends2);

exports.ListArticleMiddleware = ListArticleMiddleware;
exports.listArticleFailed = listArticleFailed;
exports.listArticle = listArticle;
exports.receiveArticle = receiveArticle;
exports.receiveArticleReducer = receiveArticleReducer;
...
var LIST_ARTICLE = exports.LIST_ARTICLE = "LIST_ARTICLE";
var RECEIVE_ARTICLE = exports.RECEIVE_ARTICLE = 'RECEIVE_ARTICLE';
var LIST_ARTICLE_FAILED = exports.LIST_ARTICLE_FAILED = 'LIST_ARTICLE_FAILED';

function ListArticleMiddleware() {
    return function (store) {
        return function (dispatch) {
            return function (action) {
                dispatch(action);
                if (action.type === LIST_ARTICLE) {
                    (0, _ArticleService.fetchArticle)(function (article) {
                        return dispatch(receiveArticle(article));
                    });
                    _simpleReactRouter.history.push('/clearblog/' + article.key);
                }
            };
        };
    };
...
function receiveArticleReducer(state, action) {
    return (0, _extends3.default)({}, state, {
